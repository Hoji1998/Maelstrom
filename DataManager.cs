...
namespace MoreMountains.CorgiEngine
{
    ...
    /// </summary>
    public class DataManager : MMSingleton<DataManager>, MMEventListener<CorgiEngineEvent>
    {
        ...
        protected const string _saveFolderName = "MainSceneData";
        protected const string _saveFileName = "MaelstromSave.data";
        ...
        {
            /*
            foreach (MaelstromScene scene in Scenes)
            {
        ...
        public virtual void SaveProgress()
        {
            ...
            progress.testNum = GameManager.Instance.testNum;
        ...
        {
            ProgressData progress = (ProgressData)MMSaveLoadManager.Load(typeof(ProgressData), _saveFileName, _saveFolderName);
            if (progress != null)
            {
                GameManager.Instance.MaximumLives = progress.MaximumLives;
                GameManager.Instance.CurrentLives = progress.CurrentLives;
                GameManager.Instance.testNum = progress.testNum;
            ...
            else
            {
                ...
                testNum = GameManager.Instance.testNum;
            }
        }
        ...
        */
        ...
        public virtual void OnMMEvent(CorgiEngineEvent gameEvent)
        {
            switch (gameEvent.EventType)
            {
                ...
                case CorgiEngineEventTypes.GameOver:
                    GameOver();
                    break;
                case CorgiEngineEventTypes.StarPicked:
                    SaveProgress();
                    break;
            }
        }
        ...
        {
            MMSaveLoadManager.DeleteSaveFolder("MainSceneData");
        }
